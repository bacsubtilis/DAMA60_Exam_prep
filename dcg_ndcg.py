# The below is calculated with incorrect formula
...
# The correct calculation is the below

import numpy as np
from sklearn.metrics import ndcg_score

ranks = np.asarray([[1, 2, 3, 4, 5]])
hits = np.asarray([[1, 0, 1, 0, 1]])


print(ndcg_score(hits, ranks))